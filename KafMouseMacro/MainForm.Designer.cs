...
partial class MainForm
{
    ...
    private void InitializeComponent()
    {
        ...
        lstPositions.Size = new Size(384, 319);
        ...
        btnAdd.Location = new Point(3, 52);
        btnAdd.Name = "btnAdd";
        ...
        btnRemove.Location = new Point(3, 85);
        ...
        btnClear.Location = new Point(3, 118);
        ...
        // Separator (label with line effect)
        var lblSep1 = new Label();
        lblSep1.AutoSize = false;
        lblSep1.Height = 6;
        lblSep1.Location = new Point(3, 148);

        // btnStart
        btnStart.AutoSize = true;
        btnStart.Location = new Point(3, 157);
        ...
        btnStop.Location = new Point(3, 190);
        ...
        lblSep2.Height = 6;
        lblSep2.Location = new Point(3, 220);

        // btnSave
        btnSave.AutoSize = true;
        btnSave.Location = new Point(3, 229);
        ...
        btnLoad.Location = new Point(3, 262);
        ...
        tlpRight.RowCount = 13;
        tlpRight.Location = new Point(6, 22);
        tlpRight.Name = "tlpRight";
        tlpRight.Size = new Size(220, 300);
        tlpRight.TabIndex = 10;
        tlpRight.Controls.Add(lblDelay, 0, 0);
        tlpRight.Controls.Add(nudDelay, 0, 1);
        tlpRight.Controls.Add(btnAdd, 0, 2);
        tlpRight.Controls.Add(btnRemove, 0, 3);
        tlpRight.Controls.Add(btnClear, 0, 4);
        tlpRight.Controls.Add(lblSep1, 0, 5);
        tlpRight.Controls.Add(btnStart, 0, 6);
        tlpRight.Controls.Add(btnStop, 0, 7);
        tlpRight.Controls.Add(lblSep2, 0, 8);
        ...
        grpControls.Size = new Size(226, 340);
        ...
        lblStatus.Location = new Point(12, 366);
